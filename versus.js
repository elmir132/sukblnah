...
function navigateDown() {
  if (scrolling && !viewscroll) {
    ...
    for (let i = 1; i <= 5; i++) {
      if (i === 1 || i === 5) {
        tl.to([$(".child-left-" + curPage + ">.left" + i), $(".child-left-" + (curPage + 1) + ">.left" + i)], animationTime, {
          x: "-=100%",
          ease: Power3.easeInOut
        }, 0.3).to([$(".child-right-" + curPage + ">.right" + i), $(".child-right-" + (curPage + 1) + ">.right" + i)], animationTime, {
          x: "+=100%",
          ease: Power3.easeInOut
        }, 0.3);
      } else if (i === 3) {
        tl.to([$(".child-left-" + curPage + ">.left" + i), $(".child-left-" + (curPage + 1) + ">.left" + i)], animationTime, {
          x: "-=100%",
          ease: Power3.easeInOut
        }, 0.15).to([$(".child-right-" + curPage + ">.right" + i), $(".child-right-" + (curPage + 1) + ">.right" + i)], animationTime, {
          x: "+=100%",
          ease: Power3.easeInOut
        }, 0.15);
      } else {
        tl.to([$(".child-left-" + curPage + ">.left" + i), $(".child-left-" + (curPage + 1) + ">.left" + i)], animationTime, {
          x: "-=100%",
          ease: Power3.easeInOut
        }, 0.25).to([$(".child-right-" + curPage + ">.right" + i), $(".child-right-" + (curPage + 1) + ">.right" + i)], animationTime, {
          x: "+=100%",
          ease: Power3.easeInOut
        }, 0.25);
      }
    ...
    for (let i = 1; i <= 5; i++) {
      if (i === 1 || i === 5) {
        tl.to([$(".child-left-" + curPage + ">.left" + i), $(".child-left-" + (curPage - 1) + ">.left" + i)], animationTime, {
          x: "+=100%",
          ease: Power3.easeInOut
        }, 0.4).to([$(".child-right-" + curPage + ">.right" + i), $(".child-right-" + (curPage - 1) + ">.right" + i)], animationTime, {
          x: "-=100%",
          ease: Power3.easeInOut
        }, 0.4);
      } else if (i === 3) {
        tl.to([$(".child-left-" + curPage + ">.left" + i), $(".child-left-" + (curPage - 1) + ">.left" + i)], animationTime, {
          x: "+=100%",
          ease: Power3.easeInOut
        }, 0.11).to([$(".child-right-" + curPage + ">.right" + i), $(".child-right-" + (curPage - 1) + ">.right" + i)], animationTime, {
          x: "-=100%",
          ease: Power3.easeInOut
        }, 0.11);
      } else {
